{
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/vimal-karthik/Fossil-Classification-Dinosaur-skull-/blob/main/CTS_Hackathon.ipynb\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "ZsW1Gc8ktIsd",
        "outputId": "43e8f9a4-487a-437f-f606-38e3e0029240"
      },
      "outputs": [
        {
          "name": "stdout",
          ...
          "text": [
            ...
            "Requirement already satisfied: starlette<0.39.0,>=0.37.2 in /usr/local/lib/python3.10/dist-packages (from fastapi>=0.95.2->chromadb) (0.38.3)\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "cOlOJPPQQDA4",
        "outputId": "2d11751f-5e11-448f-e0cc-fc12ff354588"
      },
      "outputs": [
        {
          "name": "stdout",
      ...
      "source": [
        ...
        "            border-right: 2px solid #6200EA; /* Add a purple border to match the theme */\n",
        "        }\n",
        "\n",
        "        /* Customize the main title and other texts */\n",
        "        .css-10trblm {\n",
        "            color: #E0E0E0; /* Lighter gray text for better contrast */\n",
        "            font-size: 1.5rem; /* Slightly increase the font size */\n",
        "            text-shadow: 1px 1px 2px #000; /* Add a subtle text shadow */\n",
        "        }\n",
        "\n",
        "        /* Customize the text input box */\n",
        "        .css-1dp5vir {\n",
        "            background-color: #292929; /* Darker input background for better integration */\n",
        "            color: #E0E0E0; /* Lighter text color */\n",
        "            border: 1px solid #6200EA; /* Add a purple border */\n",
        ...
        "        .css-1offfwp > button {\n",
        "            background-color: #BB86FC; /* Light purple background for a softer look */\n",
        "            color: #121212; /* Dark text for contrast */\n",
        "            border-radius: 10px; /* Rounder corners for a modern button style */\n",
        ...
        "        .user-message {\n",
        "            text-align: right;\n",
        "            background-color: #03DAC6; /* Teal color for user message */\n",
        "            color: #121212; /* Dark text for contrast */\n",
        "            border-radius: 16px; /* More rounded corners */\n",
        "            padding: 12px 18px; /* Increase padding for better spacing */\n",
        "            margin: 12px 0; /* Adjust margin for cleaner separation */\n",
        "            box-shadow: 0 4px 6px rgba(0, 0, 0, 0.2); /* Add shadow for depth */\n",
        "            max-width: 60%; /* Limit the width for a more contained bubble */\n",
        "        }\n",
        "\n",
        "        .bot-message {\n",
        "            text-align: left;\n",
        "            background-color: #BB86FC; /* Soft purple color for bot message */\n",
        "            color: #121212; /* Dark text for contrast */\n",
        "            border-radius: 16px; /* More rounded corners */\n",
        "            padding: 12px 18px; /* Increase padding for better spacing */\n",
        "            margin: 12px 0; /* Adjust margin for cleaner separation */\n",
        ...
        "        .css-1offfwp > button, .user-message, .bot-message {\n",
        ...
        "            background-color: #6200EA; /* Purple scrollbar thumb */\n",
        "            border-radius: 10px; /* Rounder corners */\n",
        "        }\n",
        "\n",
        "        ::-webkit-scrollbar-track {\n",
        "            background-color: #1F1F1F; /* Dark scrollbar track */\n",
        "        }\n",
        "    </style>\n",
        "    \"\"\",\n",
        ...
        "\n",
        "# Auto-enable or disable the Ask button based on input\n",
        "ask_button_disabled = not bool(user_input)\n",
        "\n",
        "# Button press (disable when no input and clear input after asking)\n",
        ...
        "\n",
        "    # If the same question is asked 5 or more times, mark it as an FAQ\n",
        "    if st.session_state.question_counter[user_input] >= 5:\n",
        "        st.session_state.faqs[user_input] = st.session_state.qa_cache.get(user_input, \"\")\n",
        "\n",
        "    # Check if the query is already cached\n",
        "    if user_input in st.session_state.qa_cache:\n",
        "        answer = st.session_state.qa_cache[user_input]\n",
        "    else:\n",
        ...
        "\n",
        "    # Clear the input box after the button is pressed\n",
        ...
        "    for question, answer in st.session_state.faqs.items():\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "gMZfWC7uQ5cT",
        "outputId": "111b9cf3-ca5f-4962-a721-81eb76ab84c8"
      },
      "outputs": [
        {
          "name": "stdout",
          ...
          "text": [
            "\u001b[K\u001b[?25h\n",
            "up to date, audited 23 packages in 816ms\n",
            "\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "GsaAzmqiG8C9",
        "outputId": "b331b7b2-c29b-4b64-b5df-f9a8582a3fbe"
      },
      "outputs": [
        {
          "name": "stdout",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "ZRJJXJxvG9Se",
        "outputId": "6314c0fe-17e2-40c3-d762-d199ab14ed6c"
      },
      "outputs": [
        {
          "name": "stdout",
          ...
          "text": [
            ...
            "\u001b[34m  External URL: \u001b[0m\u001b[1mhttp://34.44.211.170:8502\u001b[0m\n",
            "\u001b[0m\n",
            "your url is: https://few-birds-worry.loca.lt\n"
          ]
        }
      ],
      "source": [
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyMp+OL2JkvD3GMTg+NjyH0p",
